    ...
    while True:
        ...
        if match_crea:
            ...
            try:
                ...
                if bits_int < 1:
                    ...
                    # Al crear, las activaciones actuales son 0 (simbólico y valor)
        ...
        if match_mov:
            ...
            try:
                ...
                # Actualizar valor_decimal y su representación binaria
                ...
                # === Activaciones simbólicas visibles basadas en valor_decimal ===
                # Aplicar la función para actualizar activaciones simbólicas
        ...
        # NOTA: Este comando sigue incrementando un contador numérico.
        # Si se desea que 'act' también construya una sumatoria simbólica,
        # su lógica debería ser revisada para cómo se "incrementa" una sumatoria.
        ...
        if match_act:
            ...
            if id_neurona in neuronas_estado:
                ...
                if neurona['current_activations_val'] < neurona['max_activations_capacity_val']:
                    ...
                    # Las activaciones de 'act' siguen siendo un contador simple por ahora
...
#Espero que te guste, y te sea útil algún día
