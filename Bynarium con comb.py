...
def Bynarium_NeuronasActualizadas():
    ...
    while True:
        ...
        if match_comb:
            ...
            if neurona_llena['bits'] < 2:
                print(f"Error: La neurona '{id_llena}' (llena) debe tener al menos 2 bits para poder ceder uno.")
                continue
            ...
            # ID_Llena se reduce en 2 y se trunca a su nueva capacidad máxima
            adjusted_activations_llena = max(0, min(old_activations_llena, neurona_llena['max_activations_capacity']) - 2)
            neurona_llena['current_activations'] = adjusted_activations_llena
        ...
        if match_help_specific:
            ...
            if cmd_help == "crea":
                ...
                print("   Las activaciones actuales de la neurona 'llena' se ajustan a su nueva capacidad máxima y se reducen en 2 (simulando un costo).")
