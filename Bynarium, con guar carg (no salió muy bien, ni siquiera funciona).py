...
def generar_sumatoria_str(limite_n):
    ...
    if limite_n % 2 == 0:  # Serie de pares
        ...
        for i in range(1, limite_n + 1, 2):
            serie_elements.append(str(i))
    
    return "+".join(serie_elements)
...
def Bynarium_NeuronasActualizadas():
    ...
    patron_guar = re.compile(r"guar", re.IGNORECASE) # NUEVO patrón para 'guar' (sin nombre de archivo)
    patron_carg = re.compile(r"carg", re.IGNORECASE) # NUEVO patrón para 'carg' (sin nombre de archivo)
    ...
    while True:
        ...
        if match_help_specific:
            ...
            print("   guar") # Actualizado en el menú principal
            print("   carg") # Actualizado en el menú principal
            print("   topo: [ID]?")
