...
def Bynarium_NeuronasActualizadas():
    ...
    while True:
        ...
        if match_comb:
            ...
            # ID_Llena: Se calcula con la fórmula (bits - 2), lo que significa que sus activaciones actuales
            # serán iguales a su nueva capacidad máxima.
            neurona_llena['current_activations'] = neurona_llena['max_activations_capacity']
